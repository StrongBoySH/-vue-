...
<FrameScreen v-else></FrameScreen>
...
<script>
  ...
  export default {
    ...
    components:{UcNav,UcToolbar,FrameScreen,axios},
    mounted(){
...
<style>
  ...
  .content{max-width:6.4rem; margin:0 auto; margin-top:0.3rem; background:#f2f4f5; padding-bottom:0.85rem;}
