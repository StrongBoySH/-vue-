<template>
  <div class="content">
    ...
    <div class="footbox">
      <uc-button @click="login" style="margin-top:.23rem" class="login-btn">进入头条</uc-button>
...
<script>
	import UcNav from '../components/uc-nav/uc-nav4.vue';
...
<style scoped>
  ...
  .content h1{width:2.18rem;height:1.35rem; background:url(../assets/img/4.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
  ...
  .content .login-btn{width:2.65rem;height:0.65rem; background:#4c4f50; color:#fff; text-align:center; line-height:0.65rem; border-radius:8px; display:block; margin-top:0.62rem; font-size:0.28rem;margin: 0 auto;}
